...
## external
Any external dependencies should be in here.  These should be done as git submodules. 
...
### Real Graphs
Real graphs need an additional field which specifies if it's an addition or a deletion.  This field is at the beginning of the elements about each edge. 